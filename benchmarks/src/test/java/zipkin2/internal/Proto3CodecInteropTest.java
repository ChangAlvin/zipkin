...
public class Proto3CodecInteropTest {
  ...
  @Test public void spanSerializationIsCompatible() throws Exception {
  ...
  @Test public void writeAnnotationField_matchesProto3() throws IOException {
    ...
    Buffer buffer = new Buffer(Proto3SpanWriter.sizeOfAnnotationField(zipkinAnnotation));
    Proto3SpanWriter.writeAnnotationField(10, zipkinAnnotation, buffer);
  ...
  @Test public void sizeOfMapEntryField_matchesProto3() {
    ...
    assertThat(Proto3SpanWriter.sizeOfMapEntryField(key, value))
  ...
  @Test public void writeMapEntryField_matchesProto3() throws IOException {
    String key = "clnt/finagle.version", value = "6.45.0";
    Buffer buffer = new Buffer(Proto3SpanWriter.sizeOfMapEntryField(key, value));
    Proto3SpanWriter.writeMapEntryField(11, key, value, buffer);
  ...
  @Test public void sizeOfEndpoint_matchesProto3() {
    assertThat(Proto3SpanWriter.sizeOfEndpoint(ZIPKIN_SPAN.localEndpoint()))
      .isEqualTo(PROTO_SPAN.getLocalEndpoint().getSerializedSize());

    assertThat(Proto3SpanWriter.sizeOfEndpoint(ZIPKIN_SPAN.remoteEndpoint()))
  ...
  @Test public void writeEndpointField_matchesProto3() throws IOException {
    ...
    writeEndpointField_matchesProto3(9, ZIPKIN_SPAN.remoteEndpoint(), PROTO_SPAN.getRemoteEndpoint());
  }
  ...
  void writeEndpointField_matchesProto3(int fieldNumber, zipkin2.Endpoint zipkinEndpoint,
    ...
    Buffer buffer = new Buffer(Proto3SpanWriter.sizeOfEndpointField(zipkinEndpoint));
    Proto3SpanWriter.writeEndpointField(fieldNumber, zipkinEndpoint, buffer);
